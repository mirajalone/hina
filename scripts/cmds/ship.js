...
module.exports = {
  ...
  makeImage: async function({ one, two }) {
    ...
    pairing_img.composite(circleOne.resize(75, 75), 262, 0).composite(circleTwo.resize(80, 80), 350, 69);
  ...
  onStart: async function({ api, event, args, usersData, threadsData }) {
    ...
    return this.makeImage({one, two}).then(async pathImg => {
      var message = {
        body: `💘${namee} paired with ${name} 💘\n\nTag :• Everyone congratulates the new husband and wife`,
        mentions: arraytag,
